    ...
    <div class="container-fluid ">
        ...
        <span class="p-2 mb-1 bg-danger text-white">Rejected</span>
                 @endif</td>
                                        ...
                                        <td class="row">
                                        @if(is_null($perdeims->status))
                                            <a href="{{route('perdeim.approve', $perdeims->id)}}" title="Edit" class="m-2 btn btn-sm btn-info waves-effect waves-light leaveapproval" data-id="<?php echo $perdeims->id; ?>">Approve</a>
                                            <a href="{{route('perdeim.decline', $perdeims->id)}}" title="Edit" class="m-2 btn btn-sm btn-info waves-effect waves-light  Status" data-id = "<?php echo $perdeims->id; ?>" data-value="Rejected" >Reject</a><br>
