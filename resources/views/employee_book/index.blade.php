...
<div class="page-wrapper">
    ...
    <div class="container-fluid ">
        <div class="row m-b-10">
            <div class="col-12">
                   <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a href="{{ route('book-room.index')}}" class="text-white"><i class="" aria-hidden="true"></i>Book Room</a></button>
