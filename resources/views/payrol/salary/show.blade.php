      ...
      <div class="container-fluid">
                    ...
                    <div class="col-12">
                       <div class="card card-outline-info">
                         <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-hourglass-start" aria-hidden="true"></i> Payslip list  of month {{$payroll->month}}                
                                </h4>
                            </div>
                            <div class="card-body">
        ...
        <span class="p-2 mb-1 bg-success text-white">computed</span>
                                    ...
                                    <td>
                                           ...
                                           <a href="{{ route('payrol.show', $payrolls->id)}}" title="compute" class="m-2 btn btn-sm btn-info waves-effect waves-light leaveapp" data-id="<?php echo $payrolls->id; ?>" > generate payslip</a>
                                        </td>
