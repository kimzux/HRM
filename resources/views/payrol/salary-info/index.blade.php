...
<div class="page-wrapper">
    ...
    <div class="container-fluid ">
        <div class="row m-b-10">
            <div class="col-12">
                <button type="button" class="btn btn-info"><i class="fa fa-plus"></i><a data-toggle="modal" data-target="#leavemodel" data-whatever="@getbootstrap" class="text-white"><i class="" aria-hidden="true"></i> Add Basic Salary</a></button>
                    ...
                    <div class="card-body">
                        <div class="table-responsive ">
                            <table id="example" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                <td>{{$employee_salary->id}}</td>
                                <td>{{$employee_salary->employee->first_name}}</td>
                                <td>{{$employee_salary->basic_salary}}</td>
                                    <td class="row">
                                    <a href="{{ route('salary.edit', $employee_salary->id)}}" class="btn btn-primary">Edit</a>
                                    <form action="{{ route('salary.destroy', $employee_salary->id)}}" method="post">
                  @csrf
                  @method('DELETE')
                                    <button class="ml-4 btn btn-danger" type="submit" hidden="hidden"
        ...
        <div class="modal fade" id="leavemodel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <div class="modal-content ">
                    ...
                    <form method="post" ction="{{route('salary.store')}}" id="leaveform" enctype="multipart/form-data">
