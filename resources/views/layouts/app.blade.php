  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidebarCollapse">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item {{ Request::url() == url('/manager-dashboard') ? 'active' : '' }}">
        ...
        <li class="nav-item {{ Request::url() == url('user-management') ? 'active' : '' }}">
          <a class="nav-link" href="#sidebarComponent" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarComponents">
        ...
        <li class="nav-item dropdown ">
          <a class="nav-link" href="#sidebarRu" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRu">
        ...
        <li class="nav-item dropdown ">
          <a class="nav-link" href="#sidebarkipa" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarkipa">
        ...
        <li class="nav-item dropdown ">
          <a class="nav-link" href="#sidebarch" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarch">
        ...
        <li class="nav-item dropdown ">
          ...
          <a class="nav-link" href="#sidebarone" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarone">
        ...
        <li class="nav-item {{ Request::url() == url('/performance') ? 'active' : '' }}">
          <a class="nav-link" href="{{ route('employee-performance.index') }}">
