...
Route::get('/approve/{id}', [App\Http\Controllers\FieldController::class, 'approve'])->name('field.approve');
Route::get('/decline/{id}', [App\Http\Controllers\FieldController::class, 'decline'])->name('field.decline');
